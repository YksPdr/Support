...
namespace AppRpgEtec.Services.Armas
{
    public class ArmaService : Request
    {
        ...
        public async Task<ObservableCollection<Arma>> GetArmasAsync()
        {
            ...
            ObservableCollection<Models.Arma> listaArmas = await _request.GetAsync<ObservableCollection<Models.Arma>>(ApiUrlBase + urlComplementar, _token);
        ...
        public async Task<Arma> GetArmaAsync(int armaId)
        {
            ...
            var arma = await _request.GetAsync<Models.Arma>(ApiUrlBase + urlComplementar, _token);
